...
We highly recommend hosting your own sync server. Instructions can be found on the [Backstitch Sync Server](https://github.com/inkandswitch/backstitch-sync-server/) repository.
...
| server_url                | The URL for the sync server. It must be HTTP or HTTPS, pointing to an instance of the [Backstitch Sync Server](https://github.com/inkandswitch/backstitch-sync-server/). |
